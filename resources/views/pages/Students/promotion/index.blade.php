        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <h6 style="color: red;font-family: Cairo">{{trans('Students_trans.status_old')}}</h6><br>
                    ...
                    <form method="post" action="{{ route('promotion.store') }}">
                        ...
                        <br><h6 style="color: red;font-family: Cairo">{{trans('Students_trans.status_new')}}</h6><br>
