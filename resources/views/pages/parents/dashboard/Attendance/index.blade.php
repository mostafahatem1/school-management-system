                ...
                <div class="card card-statistics h-100">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('sons.attendance.search') }}" autocomplete="off">
                            @csrf
                            <h6 style="font-family: 'Cairo', sans-serif;color: blue">{{__('Teacher_trans.information_search')}}</h6>
                            <br>
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="card-body datepicker-form">
                                    <div class="input-group" data-date-format="yyyy-mm-dd">
                                        ...
                                        <input type="text" class="form-control range-from date-picker-default"
                                               placeholder="{{__('Teacher_trans.Start_Date')}}" required name="from">
                                        <span class="input-group-addon">{{__('Teacher_trans.to')}}</span>
                                        <input class="form-control range-to date-picker-default"
                                               placeholder="{{__('Teacher_trans.End_date')}}" type="text" required
                                               name="to">
                                    ...
                                    @foreach($Students as $student)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <span
                                                        class="text-success">{{__('attendance_trans.attendance')}}</span>
                                                @endif
                                            </td>
                                        </tr>
