...
@section('css')
    ...
    @section('title')
        {{__('fees_trans.Add_new_invoice')}}
    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
    @section('PageTitle')
        {{__('fees_trans.Add_new_invoice')}} ({{$student->name}})
    @stop
    <!-- breadcrumb -->
@endsection
@section('content')
                                ...
                                <div data-repeater-list="List_Fees">
                                    <div data-repeater-item>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <label for="Name_en" class="mr-sm-2">{{__('fees_trans.Fee_type')}}</label>
                                                <div class="box">
                                            ...
                                            <div class="col">
                                                <label for="Name_en" class="mr-sm-2">{{__('fees_trans.amount')}}</label>
                                                <div class="box">
                                            ...
                                            <div class="col">
                                                <label for="description" class="mr-sm-2">{{__('fees_trans.Notes')}}</label>
                                                <div class="box">
