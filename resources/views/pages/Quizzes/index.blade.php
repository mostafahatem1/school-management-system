                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('Quizzes.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true"> {{__('Quiz_trans.add_Quiz')}}</a><br><br>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 style="font-family: 'Cairo', sans-serif;"
                                                                    class="modal-title" id="exampleModalLabel">{{__('Quiz_trans.delete_Quiz')}}</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <p> {{trans('fees_trans.delete')}} {{$quizze->name}}</p>
