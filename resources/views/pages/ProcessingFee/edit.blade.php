...
@section('css')
    ...
    @section('title')
        {{__('fees_trans.Edit_Processors')}}
    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
    @section('PageTitle')
        {{__('fees_trans.Edit_Processors')}}   : <label style="color: red">{{$ProcessingFee->student->name}}</label>
    @stop
    <!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('ProcessingFee.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{__('fees_trans.amount')}} : <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{__('fees_trans.Notes')}} : <span class="text-danger">*</span></label>
