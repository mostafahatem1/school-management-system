...
@section('css')
    ...
    @section('title')
        {{__('library_trans.Edit_Files')}} ({{$book->title}})
    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{route('library_teacher.update','test')}}" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <a href="{{ URL::asset('attachments/library/'.$book->file_name) }}"
